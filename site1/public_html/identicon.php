...
function identicon_get_options(){
	...
	$identicon_array=$identicon->identicon_options;
...
// Create a length 624 array to store the state of the generator
 ...
 function identicon_mersenne_twister ($seed=123456) {
	...
	function mysql_math($equation){
		$result=mysql_query("SELECT ".$equation);
...
identicon_build($_GET["hash"],$_GET["hash"],true,$_GET["size"],false,true,$_GET["size"],false);
