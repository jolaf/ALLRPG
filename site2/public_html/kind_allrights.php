...
Дизайнер имеет обширные права, близкие к глав.мастеру.",
	...
	$obj_6=createElem(Array(
			...
			'sname'	=>	"Локации",
			'type'	=>	"multiselect",
			'values'	=>	array_merge(Array(Array('0','Все локации')),make5fieldtree(false,$prefix."roleslocat","parent",0," AND site_id=".$_SESSION["siteid"],"code asc, name asc",0,"id","name",1000000)),
	...
	$obj_7=createElem(Array(
			...
			'sname'	=>	"Оповещения",
			'type'	=>	"multiselect",
			'values'	=>	array_merge(Array(Array('0','Как в «локациях»')),make5fieldtree(false,$prefix."roleslocat","parent",0," AND site_id=".$_SESSION["siteid"],"code asc, name asc",0,"id","name",1000000)),
			'help'	=>	'только по этим локациям пользователь будет получать e-mail оповещения о новых и об измененных заявках (если включит себе соответствующие функции в личных настройках в «<a href="'.$server_absolute_path_site.'orders/">Поданных заявках</a>»).',
			'default'	=>	'-0-',
			'width'	=>	200,
			'read'	=>	10,
			'write'	=>	100,
